<?php
    $faqs = [
        ...
        [
            'qst' => "Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?",
            'nsw' => "<p>Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.</p>
        ...
        [
            'qst' => "Stabilire il paese associato al tuo account",
            'nsw' => "<p>Quando crei un nuovo Account Google, lo associamo a un paese in base a dove è stato creato. Per quanto riguarda gli account creati almeno un anno fa, usiamo il paese da cui accedi solitamente ai servizi Google, in genere i servizi in cui hai trascorso più tempo nell'ultimo anno.</p>
    ...
    <header>
        <div class="container-large">
            <div class="upper-header">
                <div class="logo">
                    <img class="img-logo" src="https://www.gstatic.com/images/branding/googlelogo/svg/googlelogo_clr_74x24px.svg" alt="Google">
                    <h1 class="title-logo">Privacy e termini</h1>
                </div>
                <div class="user">
                    <img src="nineDots.png" alt="">
                    <div class="mask-profile">
                        <img class="img-user" src="userImg.png" alt="">
                    </div>
                </div>
            </div>
        ...
        <div class="container ft">
            ...
            <div class="ft-right">
                ...
                <select name="language" id="language">
                    <option value="language">Italiano</option>
                    <option value="language">Inglese</option>
                    <option value="language">Francese</option>
                    <option value="language">Tedesco</option>
                    <option value="language">Spagnolo</option>
                </select>
            </div>  
        </div>
    </footer>
